...
#'
#' @param                y (list) set of sequences, each of length N, to analyze; each element in ${y} is a character vector; 
#'                         the ith element of a given character vector represents the nucleotide at the ith position of that 
#'                         sequence
...
#' @param                s (numeric interger vector; length N) specifies the set of start positions of motif instances 
#'                         (one for each sequence in ${y})
...
#'                (1)  score.sample: (numeric vector) 
#'                (2) weight.matrix: (numeric matrix) 
#'                (3)     s.updated: (numeric vector) 
#'         
