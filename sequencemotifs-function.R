...
#'
#' @param                y (list) set of sequences, each of length N, to analyze; each element in ${y} is a character vector; the ith element of 
...
#' @param                s (numeric interger vector; length N) specifies the set of start positions of motif instances (one for each sequence in ${y})
